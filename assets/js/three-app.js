...
(function main() { "use strict";
	...
	// Particle Pool ---------------------------------------------------------
		...
		function ParticlePool(poolSize) {
			...
			this.spriteTextureSignal = THREE.ImageUtils.loadTexture( "/assets/sprites/electric.png" );
			...
			//Alter color the signal color
			this.pColor = 0xfffe00;
			this.pSize = 1.53;
	...
	// Neural Network --------------------------------------------------------
		...
		function NeuralNetwork() {
			...
			this.currentMaxSignals = 2000;
			this.limitSignals = 8000;
			...
			// neuron
			this.neuronSize = 0.8;
			this.spriteTextureNeuron = THREE.ImageUtils.loadTexture( "/assets/sprites/electric.png" );
		...
		NeuralNetwork.prototype.initNeuralNetwork = function () {
			...
			loader.load('/assets/models/brain_vertex_low.obj', function constructNeuralNetwork(loadedObject) {
